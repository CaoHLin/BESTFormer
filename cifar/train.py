...
parser.add_argument('-data-dir', metavar='DIR',default="/media/data/spike-transformer-network/torch/cifar100_tmp/",
...
def main():
    ...
    if args.distillation_type != 'none':
        ...
        teacher_model.heads.head = nn.Linear(teacher_model.heads.head.in_features, args.num_classes, True)
