...
class SpikingSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        x = k.transpose(-2,-1) @ v
        x = self.attn_lif0(x)
        x = (q @ x) * self.scale * self.lambda_attn
...
class SpikingTokenizer(nn.Module):
    def __init__(self, img_size_h=128, img_size_w=128, patch_size=4, in_channels=2, embed_dims=256):
        ...
        self.proj1_conv = IRConv2d(embed_dims//8, embed_dims//4, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.proj2_conv = IRConv2d(embed_dims//4, embed_dims//2, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.proj3_conv = IRConv2d(embed_dims//2, embed_dims, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.proj4_conv = IRConv2d(embed_dims, embed_dims, kernel_size=3, stride=1, padding=1, bias=False)
