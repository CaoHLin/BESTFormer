...
parser.add_argument('-data-dir', metavar='DIR',default="/home/maoxy/code/cc/imagenet", #/dataset/ImageNet2012/
...
parser.add_argument('--resume', default='./output/train/20240714-095142-vitsnn-224/last.pth.tar', type=str, metavar='PATH',
...
parser.add_argument('--teacher-model', default='vit_b_16', type=str, metavar='MODEL',
                    help='Name of teacher model to train (default: "regnety_160"')
parser.add_argument('--teacher-path', type=str, default='./model_best.pth-16.tar')
...
def main():
    ...
    if args.distillation_type != 'none':
        ...
        teacher_model =  torchvision.models.vit_b_16(weights='ViT_B_16_Weights.IMAGENET1K_SWAG_E2E_V1')
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            ...
            loss = loss_fn(torch.nn.functional.interpolate(input, size=args.teacher_size, mode='bilinear'), (output0, output1), target)
...
def validate(model, loader, loss_fn, args, amp_autocast=suppress, log_suffix=''):
    ...
    with torch.no_grad():
        for batch_idx, (input, target) in enumerate(loader):
            ...
            with amp_autocast():
                output0, output = model(input)
                output = (output0 + output) / 2
